            ...
            >
              <Card className="h-full bg-surface-elevated border border-border/40 shadow-sm hover:shadow-md transition-all duration-150">
                <CardContent className="p-6">
                  <div className="w-11 h-11 rounded-xl bg-primary/10 text-primary border border-primary/20 flex items-center justify-center mb-4 group-hover:bg-primary group-hover:text-white transition-colors">
