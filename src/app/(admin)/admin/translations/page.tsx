...
import { ArrowLeft, Plus, Edit2, Trash2, Languages, BookOpenText } from 'lucide-react';
...
export default function AdminTranslationsPage() {
  ...
  } = useSWR('admin-editions', () => apiClient.getTranslationTafseerDetails({ page_size: 100 }));
    ...
    <div className="space-y-6 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-border/40">
          <div>
            ...
            <p className="text-sm text-text-muted mt-1">
              Manage translation editions and edit verse translations in-place
            </p>
          </div>
      ...
      <Card className="bg-surface-elevated border border-border/40 shadow-sm">
        <CardHeader className="border-b border-border/40 px-6 py-4">
          <h2 className="text-sm font-bold uppercase tracking-wider text-text-muted flex items-center gap-2">
            ...
            Translation Editions ({translations.length})
          </h2>
        </CardHeader>
        <CardContent className="p-0">
          {editionsLoading ? (
            ...
            <div className="py-12 text-center text-text-muted">
              ...
              <p className="text-base font-semibold text-text">No translation editions found</p>
              <p className="text-xs mt-1">Create a translation edition to start adding verse content.</p>
            </div>
          ) : (
      ...
      {editionId && surahNumber && selectedSurah ? (
        <VerseContentEditor
          ...
          editionId={editionId}
          surah={selectedSurah}
          field="verse_translation"
          placeholder="Enter translation for this verse..."
        ...
        <Card className="bg-surface-elevated border border-border/40 shadow-sm">
          <CardContent className="p-12 text-center text-text-muted">
            ...
            <p className="text-xs mt-1">Pick a translation edition and a surah to edit its verse translations</p>
          </CardContent>
        </Card>
      )}
      ...
      <ConfirmDialog
        open={!!deleteTarget}
        title="Delete Translation Edition"
        message={
          deleteTarget
...
function EditionModal({ state, onClose, onSaved }: EditionModalProps) {
  return (
    <Modal
      open={!!state}
      onClose={onClose}
      title={state?.mode === 'edit' ? 'Edit Translation Edition' : 'Add Translation Edition'}
      footer={
        <>
